...
<form action="PostManagement" method="post" id="searchForm">
<div class="search-and-sort">
    <div style="display:flex;justify-content: space-between">
        <div class="search-container">
                <input type="text" name="searchPost" id="search" placeholder="Search...">
        ...
        <div class="sort-container">
            ...
            <select name="sort">
                <option value="postID" ${param.sort == 'postID' ? 'selected' : '' } default>ID</option>
                <option value="title" ${param.sort == 'title' ? 'selected' : '' }>Title</option>
                <option value="updatedDate" ${param.sort == 'updatedDate' ? 'selected' : '' }>Updated Date</option>
            </select>
