...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/JSP/Register/register.css" />
</head>
            ...
            <div class="form">
                <div class="sign">
                    <form action="${pageContext.request.contextPath}/Login" method="post" class="signin">
                        ...
                        <input type="submit" name="action" value="Login" class="button logButton">
...
<!--                            <a href="#" class="socialicon">
            ...
            <div class="panels">
                <div class="panel left">
                    ...
                    <img src="${pageContext.request.contextPath}/JSP/Register/login.svg" class="image">
                </div>
                ...
                <div class="panel right">
                    ...
                    <img src="${pageContext.request.contextPath}/JSP/Register/register.svg" class="image">
                </div>
            </div>
        </div>
    </div>
    <script src="${pageContext.request.contextPath}/JSP/Register/register.js"></script>
</body>
